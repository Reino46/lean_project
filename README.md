...
Αυτό το repository περιέχει τις σημειώσεις, τις ασκήσεις και τους κώδικες από τη μελέτη μου στο βιβλίο **"Theorem Proving in Lean 4" (TPIL4)**.
...
- **Βιβλιοθήκες:** Χρήση της `Mathlib` για μαθηματικά θεωρήματα και tactics.
